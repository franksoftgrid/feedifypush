...
import static com.feed.sdk.push.NotificationProvider.NOTIFICATION_TYPE;
...
public class FeedSDKActionButton extends AppCompatActivity {
    ...
    public static class ButtonReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            final int notificationId = intent.getIntExtra(NOTIFICATION_KEY, 0);
            final String notificationType = intent.getStringExtra(NOTIFICATION_TYPE);
            ...
            intent = null;
            FeedNotificationDataManager.captureClick(notificationId, notificationType);
